...
class TrianguloEquilateroInscrito:
    ...
    def __init__(self,radio):
        ...
        self.lado = round(math.sqrt(3)*radio) #raiz de 3 por el radio
...
def main():
    ...
    ventana = glfw.create_window(801, 801, "Triangulo Equilatero Inscrito", None, None)
    ...
    TEI = TrianguloEquilateroInscrito(118)
