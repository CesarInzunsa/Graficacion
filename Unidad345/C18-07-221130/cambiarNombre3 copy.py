...
def main():
    ...
    while not glfw.window_should_close(ventana):
        ...
        anillo.trazar()
        time.sleep(0.1)
        #Si la camara y rotar en y son iguales entonces es como si no se moviera el cubo porque rota siguiendo a la camara.
        anillo.rotarX(5) #tambien afecta el modelo porque pasa por una cara
        ...
        glMatrixMode(GL_MODELVIEW)
        glLoadIdentity()
        gluLookAt(xv,yv,zv,0,0,0,0,1,0)
